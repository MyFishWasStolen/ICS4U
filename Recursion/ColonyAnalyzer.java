...
public class ColonyAnalyzer
{
        ...
        for (int r = 0; r < rows; r++)
        {
            ...
            for (int c = 0; c < cols; c++)
            {
                ...
                if (slide[r][c] != 0)
                {
                    ...
                    // Measure the size of the colony starting and erase it by setting its cells to 0
    ...
    private int measureAndErase(int r, int c, int color)
    {
        ...
        // Initialize the size of the colony found from this cell to 1
        int size = 1;

        // Recursively explore all four directions from the first cell
